//imports
// importing ethers from ethers will require us to have the binary and ABI of the contract
// as hardhat knows about where it is already, we can import ethers from hardhat directly as it is already delivered with it
// ..Added run and network.
// Run allows to run any task from hardhat by using code instead of CLI
// network gives us informations about currently in use network when deploying
...
*/
    ...
    //account amount status after everything
    console.log(
