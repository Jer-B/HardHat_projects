...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        console.log("NFT mint token initialization");

        console.log("counter", s_tokenCounter);
        //tokenId update
        //
        ...
        // 88 -> St Bernard
        // 45 -> St Bernard
        console.log("Modded RNG ", moddedRng);
        Breed dogBreed = getBreedFromModdedRng(moddedRng);

        //then mint
        console.log("mint new token initialization");
        console.log("Nft owner", dogOwner);
        console.log("Nft ID ", newTokenId);
        console.log("requester ", msg.sender);
